...
<script>
import { listOpenresultGs1mkl8, getOpenresultGs1mkl8, delOpenresultGs1mkl8, updateOpenresultGs1mkl8 } from "@/api/lottery/openresultGs1mkl8";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultGs1mkl8(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultGs1mkl8(obj).then(response => {
