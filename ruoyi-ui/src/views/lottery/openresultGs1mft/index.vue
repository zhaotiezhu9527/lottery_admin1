...
<script>
import { listOpenresultGs1mft, getOpenresultGs1mft, delOpenresultGs1mft, updateOpenresultGs1mft } from "@/api/lottery/openresultGs1mft";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultGs1mft(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultGs1mft(obj).then(response => {
