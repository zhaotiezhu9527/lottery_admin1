...
<script>
import { listOpenresultGs1mlhc, getOpenresultGs1mlhc, delOpenresultGs1mlhc, updateOpenresultGs1mlhc } from "@/api/lottery/openresultGs1mlhc";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultGs1mlhc(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultGs1mlhc(obj).then(response => {
