...
<script>
import { listOpenresultGs1mssc, getOpenresultGs1mssc, delOpenresultGs1mssc, updateOpenresultGs1mssc } from "@/api/lottery/openresultGs1mssc";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultGs1mssc(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultGs1mssc(obj).then(response => {
