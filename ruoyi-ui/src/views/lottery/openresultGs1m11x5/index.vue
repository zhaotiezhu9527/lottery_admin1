...
<script>
import { listOpenresultGs1m11x5, getOpenresultGs1m11x5, delOpenresultGs1m11x5, updateOpenresultGs1m11x5 } from "@/api/lottery/openresultGs1m11x5";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultGs1m11x5(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultGs1m11x5(obj).then(response => {
