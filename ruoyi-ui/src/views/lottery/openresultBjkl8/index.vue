...
<script>
import { listOpenresultBjkl8, getOpenresultBjkl8, delOpenresultBjkl8, updateOpenresultBjkl8 } from "@/api/lottery/openresultBjkl8";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultBjkl8(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultBjkl8(obj).then(response => {
