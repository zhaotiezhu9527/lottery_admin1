<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="地址详情" prop="addrDetail">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['lottery:userLoginLog:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['lottery:userLoginLog:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="userLoginLogList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="地址详情" align="center" prop="addrDetail" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="地址详情" prop="addrDetail">
          <el-input v-model="form.addrDetail" placeholder="请输入地址详情" />
        </el-form-item>
        <el-form-item label="登录域名" prop="loginDomain">
...
<script>
import { listUserLoginLog, getUserLoginLog, delUserLoginLog, addUserLoginLog, updateUserLoginLog } from "@/api/lottery/userLoginLog";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listUserLoginLog(this.queryParams).then(response => {
    ...
    handleUpdate(row) {
      ...
      getUserLoginLog(id).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateUserLoginLog(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addUserLoginLog(this.form).then(response => {
