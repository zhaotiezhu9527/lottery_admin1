...
<script>
import { listOpenresultGd11x5, getOpenresultGd11x5, delOpenresultGd11x5, updateOpenresultGd11x5 } from "@/api/lottery/openresultGd11x5";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultGd11x5(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultGd11x5(obj).then(response => {
