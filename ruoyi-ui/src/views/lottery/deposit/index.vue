<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="充值账户详情" prop="accountDetail">
        <el-input
          v-model="queryParams.accountDetail"
          placeholder="请输入充值账户详情"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="用户充值信息详情" prop="depositDetail">
        <el-input
          v-model="queryParams.depositDetail"
          placeholder="请输入用户充值信息详情"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['lottery:deposit:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['lottery:deposit:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['lottery:deposit:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="depositList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="1:银行卡 2:微信 3:支付宝 4:虚拟货币 5:在线支付" align="center" prop="depositType" />
      ...
      <el-table-column label="0:待审核 1:审核成功 2:审核失败" align="center" prop="status" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="充值账户详情" prop="accountDetail">
          <el-input v-model="form.accountDetail" placeholder="请输入充值账户详情" />
        </el-form-item>
        <el-form-item label="用户充值信息详情" prop="depositDetail">
          <el-input v-model="form.depositDetail" placeholder="请输入用户充值信息详情" />
        </el-form-item>
      </el-form>
...
<script>
import { listDeposit, getDeposit, delDeposit, addDeposit, updateDeposit } from "@/api/lottery/deposit";
