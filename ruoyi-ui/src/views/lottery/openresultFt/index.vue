...
<script>
import { listOpenresultFt, getOpenresultFt, delOpenresultFt, updateOpenresultFt } from "@/api/lottery/openresultFt";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultFt(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultFt(obj).then(response => {
