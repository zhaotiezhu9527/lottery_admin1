...
<script>
import { listOpenresultMo6hc, getOpenresultMo6hc, delOpenresultMo6hc, updateOpenresultMo6hc } from "@/api/lottery/openresultMo6hc";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultMo6hc(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultMo6hc(obj).then(response => {
