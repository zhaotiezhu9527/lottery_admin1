...
<script>
import { listOpenresultGs1mpcdd, getOpenresultGs1mpcdd, delOpenresultGs1mpcdd, updateOpenresultGs1mpcdd } from "@/api/lottery/openresultGs1mpcdd";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultGs1mpcdd(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultGs1mpcdd(obj).then(response => {
