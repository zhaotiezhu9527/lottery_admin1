...
<script>
import { listOpenresultPcdd, getOpenresultPcdd, delOpenresultPcdd, updateOpenresultPcdd } from "@/api/lottery/openresultPcdd";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultPcdd(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultPcdd(obj).then(response => {
