<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="订单号(自己平台)" prop="orderNo">
        <el-input
          v-model="queryParams.orderNo"
          placeholder="请输入订单号(自己平台)"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['lottery:eduOrder:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['lottery:eduOrder:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="eduOrderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单号(自己平台)" align="center" prop="orderNo" />
      <el-table-column label="三方订单号" align="center" prop="platOrderNo" />
      <el-table-column label="转换金额" align="center" prop="amount" />
      <el-table-column label="0:转入 1:转出" align="center" prop="eduType" />
      <el-table-column label="平台代码" align="center" prop="platCode" />
      <el-table-column label="-1:异常 0:成功 1:失败" align="center" prop="status" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="订单号(自己平台)" prop="orderNo">
          <el-input v-model="form.orderNo" placeholder="请输入订单号(自己平台)" />
        </el-form-item>
        <el-form-item label="三方订单号" prop="platOrderNo">
          <el-input v-model="form.platOrderNo" placeholder="请输入三方订单号" />
        </el-form-item>
        <el-form-item label="转换金额" prop="amount">
          <el-input v-model="form.amount" placeholder="请输入转换金额" />
        </el-form-item>
        <el-form-item label="平台代码" prop="platCode">
...
<script>
import { listEduOrder, getEduOrder, delEduOrder, addEduOrder, updateEduOrder } from "@/api/lottery/eduOrder";
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateEduOrder(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addEduOrder(this.form).then(response => {
