<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="openresultk3List">
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultGs1mk3(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
        this.openresultk3List = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultGs1mk3(obj).then(response => {
