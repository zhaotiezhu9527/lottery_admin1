...
<script>
import { listOpenresultJsk3, getOpenresultJsk3, delOpenresultJsk3, updateOpenresultJsk3 } from "@/api/lottery/openresultJsk3";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOpenresultJsk3(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateOpenresultJsk3(obj).then(response => {
